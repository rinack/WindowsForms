...
namespace Windows.Forms.Controls.QQControls
{
    ...
    public class QQGlassButton : PictureBox, IButtonControl
    {
        ...
        private Image _glassHotImg = AssemblyHelper.GetImage("QQControls.QQGlassButton.Image.glassbtn_hot.png");
        private Image _glassDownImg = AssemblyHelper.GetImage("QQControls.QQGlassButton.Image.glassbtn_down.png");
