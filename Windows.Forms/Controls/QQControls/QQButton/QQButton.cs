...
namespace Windows.Forms.Controls.QQControls
{
    ...
    public class QQButton : Button
    {
        ...
        private Image _normalImg = AssemblyHelper.GetImage("QQControls.QQButton.Image.qqbtn_normal.png");//AssemblyHelper.GetImage("QQButton.Image.qqbtn_normal.png");
        private Image _highlightImg = AssemblyHelper.GetImage("QQControls.QQButton.Image.qqbtn_highlight.png");
        private Image _focusImg = AssemblyHelper.GetImage("QQControls.QQButton.Image.qqbtn_focus.png");
        private Image _downImg = AssemblyHelper.GetImage("QQControls.QQButton.Image.qqbtn_down.png");
