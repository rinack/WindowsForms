...
namespace Windows.Forms.Controls.QQControls
{
    ...
    public class QQCheckBox : CheckBox
    {
        ...
        private Image _checkImg = AssemblyHelper.GetImage("QQControls.QQCheckBox.Image.check.png");//RenderHelper.GetImageFormResourceStream("QQCheckBox.Image.check.png");
