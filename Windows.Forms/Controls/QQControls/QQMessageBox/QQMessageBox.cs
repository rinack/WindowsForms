...
namespace Windows.Forms.Controls.QQControls
{
    /// <summary>
    /// 仿QQ效果的MessageBox
    /// </summary>
    public class QQMessageBox : StanForm
    {
        ...
        private void LoadMsgBoxIcon(QQMessageBoxIcon msgBoxIcon)
        {
            switch (msgBoxIcon)
            {
                case QQMessageBoxIcon.Error:
                    _msgBoxIcon = AssemblyHelper.GetImage("QQControls.QQMessageBox.Icons.qqmessagebox_error.png");
                    break;
                case QQMessageBoxIcon.Information:
                    _msgBoxIcon = AssemblyHelper.GetImage("QQControls.QQMessageBox.Icons.qqmessagebox_infor.png");
                    break;
                case QQMessageBoxIcon.OK:
                    _msgBoxIcon = AssemblyHelper.GetImage("QQControls.QQMessageBox.Icons.qqmessagebox_ok.png");
                    break;
                case QQMessageBoxIcon.Question:
                    _msgBoxIcon = AssemblyHelper.GetImage("QQControls.QQMessageBox.Icons.qqmessagebox_question.png");
                    break;
                case QQMessageBoxIcon.Warning:
                    _msgBoxIcon = AssemblyHelper.GetImage("QQControls.QQMessageBox.Icons.qqmessagebox_warning.png");
                    break;
                default:
                    break;
            }
