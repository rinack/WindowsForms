...
namespace Windows.Forms.Controls.ControlsEx
{
    ...
    public partial class QQTextBoxEx : UserControl
    {
        ...
        private Image _borderImage = AssemblyHelper.GetImage("StanForm.TextBox.normal.png");
        ...
        {
            this.BaseText = new QQTextBoxBase();
            this.SuspendLayout();
            // 
            // BaseText
            // 
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            switch (this._mouseState)
            {
                case EMouseState.Move:
                    using (Image hotLine = AssemblyHelper.GetImage("StanForm.TextBox.move.png"))
                    {
