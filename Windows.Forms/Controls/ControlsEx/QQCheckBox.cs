...
namespace Windows.Forms.Controls.ControlsEx
{
    /// <summary>
    /// CheckBox
    /// </summary>
                ...
                switch (this.CheckState)
                {
                    ...
                    case CheckState.Unchecked:
                        Bitmap bitmap = new Bitmap(
                            AssemblyHelper.GetImage("StanForm.CheckBox.normal.png"));
            ...
            else
            {
                switch (this._mouseState)
                {
                    ...
                    case EMouseState.Leave:
                        if (base.Checked)
                        {
                            using (Image normal = AssemblyHelper.GetImage("StanForm.CheckBox.tick_normal.png"))
                            {
                        ...
                        {
                            using (Image normal = AssemblyHelper.GetImage("StanForm.CheckBox.normal.png"))
                            {
                                g.DrawImage(normal, this.ImageRect);
                            }
                        }
                    ...
                    case EMouseState.Move:
                        if (base.Checked)
                        {
                            using (Image high = AssemblyHelper.GetImage("StanForm.CheckBox.tick_highlight.png"))
                            {
                        ...
                        {
                            using (Image high = AssemblyHelper.GetImage("StanForm.CheckBox.hightlight.png"))
                            {
                                g.DrawImage(high, this.ImageRect);
                            }
                        }
                ...
                if (base.CheckState == CheckState.Indeterminate)
                {
                    ...
                    {
                        using (Image normal = AssemblyHelper.GetImage("StanForm.CheckBox._tick_normal.png"))
                        {
                            g.DrawImage(normal, this.ImageRect);
                        }
                    }
                    ...
                    {
                        using (Image high = AssemblyHelper.GetImage("StanForm.CheckBox._tick_highlight.png"))
                        {
                            g.DrawImage(high, this.ImageRect);
                        }
                    }
