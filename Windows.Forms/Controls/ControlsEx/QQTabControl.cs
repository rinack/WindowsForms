...
namespace Windows.Forms.Controls.ControlsEx
{
    ...
    {
        #region 变量
        private Image _titleBackground = AssemblyHelper.GetImage("StanForm.TabControl.main_tab_bkg.png");
        ...
        private void DrawTabPages(Graphics g)
        {
            ...
            for (int i = 0; i < base.TabCount; i++)
            {
                ...
                {
                    baseTabHeaderImage = AssemblyHelper.GetImage("StanForm.TabControl.main_tab_check.png");
                    ...
                    if (contextMenuStrip != null)
                    {
                        ...
                        if (tabRect.Contains(cursorPoint))
                        {
                            if (this._isFocus)
                            {
                                btnArrowImage = AssemblyHelper.GetImage("StanForm.TabControl.main_tabbtn_down.png");
                                contextMenuStrip.Show(contextMenuLocation);
                            }
                            else
                            {
                                btnArrowImage = AssemblyHelper.GetImage("StanForm.TabControl.main_tabbtn_highlight.png");
                            }
                ...
                {
                    baseTabHeaderImage = AssemblyHelper.GetImage("StanForm.TabControl.main_tab_highlight.png");
                }
