        ...
        public virtual Image NormalImage
        {
            get
            {
                if (this._normalImage == null)
                    this._normalImage = AssemblyHelper.GetImage("StanForm.Button.normal.png");
        ...
        public virtual Image DownImage
        {
            get
            {
                if (this._downImage == null)
                    this._downImage = AssemblyHelper.GetImage("StanForm.Button.down.png");
        ...
        public virtual Image MoveImage
        {
            get
            {
                if (this._moveImage == null)
                    this._moveImage = AssemblyHelper.GetImage("StanForm.Button.highlight.png");
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            if (base.Enabled)
            {
                if (this.IsShowBorder)
                {
                    ...
                    {
                        using (Image light = AssemblyHelper.GetImage("StanForm.Button.Light.png"))
                        {
                ...
                switch (this.MouseState)
                {
                    ...
                    case EMouseState.Normal:
                        if (base.Focused)
                        {
                            if (this.IsShowBorder)
                            {
                                using (Image focus = AssemblyHelper.GetImage("StanForm.Button.focus.png"))
                                {
            ...
            {
                using (Image gray = AssemblyHelper.GetImage("StanForm.Button.gray.png"))
                {
