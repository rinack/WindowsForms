        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            switch (this.MouseState)
            {
                ...
                case EMouseState.Normal:
                    if (base.Checked)
                    {
                        using (Image normal = AssemblyHelper.GetImage("StanForm.RadioButton.tick_normal.png"))
                        {
                    ...
                    {
                        using (Image normal = AssemblyHelper.GetImage("StanForm.RadioButton.normal.png"))
                        {
                            g.DrawImage(normal, this.ImageRect);
                        }
                    }
                ...
                case EMouseState.Up:
                    if (base.Checked)
                    {
                        using (Image high = AssemblyHelper.GetImage("StanForm.RadioButton.tick_highlight.png"))
                        {
                    ...
                    {
                        using (Image high = AssemblyHelper.GetImage("StanForm.RadioButton.highlight.png"))
                        {
                            g.DrawImage(high, this.ImageRect);
                        }
                    }
