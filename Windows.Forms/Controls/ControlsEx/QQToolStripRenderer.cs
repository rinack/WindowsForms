...
namespace Windows.Forms.Controls.ControlsEx
{
    ...
    public class QQToolStripRenderer : ToolStripRenderer
    {
        ...
        protected override void OnRenderToolStripBackground(ToolStripRenderEventArgs e)
        {
            ...
            Image bgk = AssemblyHelper.GetImage("StanForm.ContextMenu.menu_bkg.png");
            Image board = AssemblyHelper.GetImage("StanForm.ContextMenu.menu_bkg_board.png");
        ...
        {
            Graphics g = e.Graphics;
            Image arrow = AssemblyHelper.GetImage("StanForm.ContextMenu.menu_arrow.png");
        ...
        protected override void OnRenderMenuItemBackground(ToolStripItemRenderEventArgs e)
        {
            ...
            if (toolstrip is ToolStrip)
            {
                ...
                if (item.Selected)
                {
                    ...
                    Image select = AssemblyHelper.GetImage("StanForm.ContextMenu.menu_highlight.png");
        ...
        protected override void OnRenderSeparator(ToolStripSeparatorRenderEventArgs e)
        {
            if (!e.Vertical)
            {
                Image cutling = AssemblyHelper.GetImage("StanForm.ContextMenu.menu_cutling.png");
                Rectangle rect = new Rectangle(
        ...
        {
            Image check = AssemblyHelper.GetImage("StanForm.ContextMenu.menu_check.png");
