...
namespace Windows.Forms.Controls.Forms.StyleForm
{
    public partial class FlatForm : BaseForm
    {
        ...
        /// 边框图片
        /// </summary>
        private Image _borderImage = AssemblyHelper.GetImage("FlatForm.Form.framemod.png");
        /// <summary>
        /// 关闭按钮图片
        /// </summary>
        private Image _closeImage = AssemblyHelper.GetImage("FlatForm.SysButton.sys_button_close.png");
        /// <summary>
        /// 最小化按钮图片
        /// </summary>
        private Image _minImage = AssemblyHelper.GetImage("FlatForm.SysButton.sys_button_min.png");
        /// <summary>
        /// 最大化按钮图片
        /// </summary>
        private Image _maxImage = AssemblyHelper.GetImage("FlatForm.SysButton.sys_button_max.png");
        /// <summary>
        /// 还原按钮图片
        /// </summary>
        private Image _restoreImage = AssemblyHelper.GetImage("FlatForm.SysButton.sys_button_restore.png");
        /// <summary>
        /// 标题栏菜单按钮图片
        /// </summary>
        private Image _titleBarMenuImage = AssemblyHelper.GetImage("FlatForm.SysButton.title_bar_menu.png");
