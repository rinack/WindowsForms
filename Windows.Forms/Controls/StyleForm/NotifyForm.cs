...
namespace Windows.Forms.Controls.Forms.StyleForm
{
    public partial class NotifyForm : StanForm
    {
        ...
        /// 背景图片
        /// </summary>
        private Image _backImage = AssemblyHelper.GetImage("StanForm.SkinMgr.all_inside02_bkg.png");
        /// <summary>
        /// 分割线
        /// </summary>
        private Image _splitImage = AssemblyHelper.GetImage("StanForm.FormFrame.ContactFilter_splitter.png");
