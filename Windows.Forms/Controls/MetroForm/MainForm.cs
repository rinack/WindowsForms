...
namespace Windows.Forms.Controls.MetroForm
{
    public partial class MainForm : Form
    {
        //控件层
        private Windows.Forms.Controls.StyleForm.MetroForm Main;

        //带参构造
        public MainForm(Windows.Forms.Controls.StyleForm.MetroForm main)
        {
            //将控制层传值过来
            this.Main = main;
            InitializeComponent();
        ...
        public void SetBits()
        {
            ...
            ImageDrawRect.DrawRect(g, new Bitmap(AssemblyHelper.GetImage("StanForm.SkinMgr.all_light_bkg.png")), ClientRectangle, Rectangle.FromLTRB(_BacklightLTRB.X, _BacklightLTRB.Y, _BacklightLTRB.Width, _BacklightLTRB.Height), 1, 1);
